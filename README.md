...
csv2db.py is used to convert the csvs of the Red Light Camera Violations and Speed Camera Violations into a sqlite file which is used by ctca.py to analyze the data from the csvs.
